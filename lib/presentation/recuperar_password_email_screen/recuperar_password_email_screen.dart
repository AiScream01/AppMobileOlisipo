...
class RecuperarPasswordEmailScreen extends StatelessWidget {
  ...
  Widget _buildPasswordRecovery(BuildContext context) {
    return Expanded(
        child: Container(
            padding: EdgeInsets.symmetric(horizontal: 14.h, vertical: 23.v),
  ...
  /// Navigates to the recuperarPasswordConfirmarPasswordScreen when the action is triggered.
  onTapRecuperar(BuildContext context) {
    Navigator.pushNamed(
        context, AppRoutes.recuperarPasswordConfirmarPasswordScreen);
  }
